    ...
    try {
      ...
      const basePayload = {
        ...
        electrical_conductivity:
          Number(form.electrical_conductivity),
      ...
      if (mode === "location-aware") {
        ...
        response =
          await predictLocationAwareCrop({
      ...
      const formattedResults =
        (response.top_5_crops || [])
          .map((crop) => ({

            name: crop.crop,

            probability:
              Number(crop.probability),

          }));


      console.log(
        "FORMATTED CROP RESULTS:",
        formattedResults
      );
